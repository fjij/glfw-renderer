...
shader::Shader::Shader(std::string vertex_shader_path, std::string fragment_shader_path) {
...
void shader::Shader::set_bool(const std::string &name, bool value) const {
	glUniform1i(glGetUniformLocation(ID, name.c_str()), (int)value);
}

void shader::Shader::set_int(const std::string &name, int value) const {
